                   ...
                   <form action="wiki.php" method="POST" enctype="multipart/form-data" >
                      ...
                      <div class="form-group has-success col-md-4">
                       ...
                       <div class="form-group has-success col-md-3" style="margin: 2%;">
                          <button class="btn btn-danger" name="add_category" type="submit">ADD IMAGE FROM WIKIPEDIA</button><br/><br/>
                      </div>
                  </form>
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Images</div>
                            ...
                            <form action="" method="post">
                                <table class="table table-bordered table-hover DynamicTable">
                                    <thead>
                                        <tr>
                                            <th class="numeric">Discription</th>
