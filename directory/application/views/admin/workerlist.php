...
td {
    word-wrap:break-word!important;
      ...
      <td><img src="/directory/uploads/<?php echo $row['image']; ?>" alt="image"  height="50" width="50"/>
		    ...
		    <td><a href="<?php echo base_url(); ?>index.php/specialist/work_Data/<?php echo $row['work_id']; ?>">Edit</a>-||-<a href=""><a href="<?php echo base_url(); ?>index.php/specialist/delete_workerdata/<?php echo $row['work_id']; ?>">Delete</a></td>
			</tr>
                  <?php }
