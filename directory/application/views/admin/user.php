       ...
       <!-- End : Side bar -->
        <div id="content">  <!-- Start : Inner Page Content -->
            <div class="container"> <!-- Start : Inner Page container -->
                ...
                <div class="row">
                  ...
                  <!--  <a class="more" href="user.php">
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i> User Details</div>   
                                  <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn mini green" href="<?php echo base_url(); ?>/index.php/user/add_user" >
                   ...
                   <tr><th>ID</th><th>Name</th><th>Mobile</th><th>Email</th><th>Action</th></tr>
                <?php
              echo "<br>";
              echo "<br>";
              echo "<br>";
		  ...
		  <tr>
			...
			<td><a href="<?php echo base_url(); ?>index.php/user/find_Data/<?php echo $row['id']; ?>">Edit</a>-||-<a href=""><a href="<?php echo base_url(); ?>index.php/user/delete_Data/<?php echo $row['id']; ?>">Delete</a></td>
			</tr>
                  <?php }
