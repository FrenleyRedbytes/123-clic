        ...
        <div id="content">  <!-- Start : Inner Page Content -->
            <div class="container"> <!-- Start : Inner Page container -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i> Category Details</div>                               
                                <div class="actions">
                                    <div class="btn-group">
				   ...
				   <p style="font-size:24px;top:20px; position:relative;">Welcome in ADMIN Dashboard TO <?php echo $this->session->userdata('email'); ?></p>
                <?php
              echo "<br>";
              echo "<br>";
              echo "<br>";
		  ...
		  <tr>
			...
			<td><img src="/directory/uploads/<?php echo $row['logo']; ?>" alt="image"  height="50" width="50"/></td>
			<td><a href="<?php echo base_url(); ?>index.php/dashboard/find_Data/<?php echo $row['cat_id']; ?>">Edit</a>-||-<a href=""><a href="<?php echo base_url(); ?>index.php/dashboard/delete_Data/<?php echo $row['cat_id']; ?>">Delete</a></td>
			</tr>
                  <?php }
