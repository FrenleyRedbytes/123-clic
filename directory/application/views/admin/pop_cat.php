        ...
        <div class="container">
          ...
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              <li class="current">
                <i class="fa fa-home"></i>Popularity of Categories
              </li>
            </ul>
          </div>
          <div class="page-header">
            <div class="page-title">
              <h3>Popularity of Categories</h3>
           </div>
          </div>
            <form action="" method="POST" enctype="multipart/form-data" >
                      ...
                      <div class="form-group has-success col-md-8">
                       ...
                       <div class="form-group has-success col-md-6">
                          <button class="btn btn-danger" name="add_category" type="submit">Show</button><br/><br/>
                      </div>
                </form>
          <div class="row">
            ...
            if(isset($_POST['category']))
              {
               ...
               $tutor_info1=mysqli_query($con,"SELECT * FROM category WHERE `id`='$cat' ");
               $tutor_info11 = mysqli_fetch_array($tutor_info1);
              $cat_name=$tutor_info11['name'];

             $sql_con = mysqli_query($con,"SELECT count(*) as coun,status FROM image_status where `cat_id`='$cat' GROUP BY status");
                               $count = 0;
                               while($row_con = mysqli_fetch_array($sql_con))
                               {  
