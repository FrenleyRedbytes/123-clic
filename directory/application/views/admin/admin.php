       ...
       <!-- End : Side bar -->
        <div id="content">  <!-- Start : Inner Page Content -->
		  ...
		  <tr>
			...
			<td><img src="/directory/uploads/<?php echo $row['image']; ?>" alt="image"  height="50" width="50"/></td>
			<td><?php echo $row['email']; ?></td>
		    <td><a href="<?php echo base_url(); ?>index.php/addadmin/find_Data/<?php echo $row['id']; ?>">Edit</a>-||-<a href=""><a href="<?php echo base_url(); ?>index.php/addadmin/delete_Data/<?php echo $row['id']; ?>">Delete</a></td>
			</tr>
                  <?php }
