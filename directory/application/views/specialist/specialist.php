...
td {
    word-wrap:break-word!important;
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i> Specialist Details</div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn mini green" href="<?php echo base_url() ; ?>index.php/specialist/add_specialist">
                                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Specialist 
                                        </a>
                                       </div>
                                </div>
                            </div>
      ...
      <td><?php echo $row['spe_id']; ?></td>
			...
			<td><img src="/directory/uploads/<?php echo $row['brand_logo']; ?>" alt="image"  height="50" width="50"/>
			</td>
			<td><?php echo $row['contact_name']; ?></td>
			<td><img src="/directory/uploads/<?php echo $row['contact_image']; ?>" alt="image"  height="50" width="50"/></td>
		
			
			<td><?php echo $row['email']; ?></td>
		    <td><a href="<?php echo base_url(); ?>index.php/specialist/find_Data/<?php echo $row['spe_id']; ?>">Edit</a>-||-<a href=""><a href="<?php echo base_url(); ?>index.php/specialist/delete_Data/<?php echo $row['spe_id']; ?>">Delete</a></td>
			</tr>
                  <?php }
