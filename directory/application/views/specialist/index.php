...
<body class="login" style="background: #fff;">
    ...
    <div class="content">         
		<?php echo form_open('specialist_login'); ?>            
            <h3 class="form-title">Connectez-vous &agrave; votre compte</h3>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-icon left">
                        <i class="fs-user-2"></i>
                        <input class="form-control" type="text" placeholder="Email utilisateur" name="email"/>
                    </div>
                </div>
            </div>            
            <div class="control-group">
            ...
            <div class="form-actions">
                  <input type="submit" class="btn green pull-left" name="btn_login" value=" Se connecter" style="
                    margin-right: 20px;
                ">
            </div>
            <div class="form-actions">
                  <a href="<?php echo base_url(); ?>index.php/specialist_login/forget">Mot de passe oubli&eacute;</a>
            </div>
        </form> 		
        <?php 
        echo form_close(); 
