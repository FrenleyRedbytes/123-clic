    ...
    <header class="header navbar navbar-fixed-top" role="banner"> 
        <div class="container"> 
            ...
            <a class="navbar-brand" href="#"> 
              <img src="<?php echo base_url(); ?>img/logo.png" alt="Directory" style="width: 87px;
height: auto;
margin-left: 53px;
margin-top: 4px;"/>
            </a>
            ...
            <ul class="nav navbar-nav navbar-right">                 
                <li class="dropdown user" style="margin-left: -27%;">  
                    ...
                    "><?php echo $this->session->userdata('name'); ?></b>&nbsp;<i class="fa fa-user" style="background-color: #c5475d;padding: 9px;border-radius: 50%"></i>
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/Specialist1/profile">
                                <i class="fs-user"></i> Mon Profil
                            </a>
                        </li> 
                         <li>
                            <a href="<?php echo base_url(); ?>index.php/Specialist1/change_password">
                                <i class="fa fa-power-off"></i> Changer mot de passe
                            </a>
                        </li> 
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/dashboard_specialist/logout">
