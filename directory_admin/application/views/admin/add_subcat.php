   ...
   <!--  <div class="crumbs">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3 style="color: #850035;">Ajouter une sous-cat&eacute;gorie</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
          <?php
           echo form_open_multipart('Subcategory/add_subcat');
         ?>
         <div class="form-group has-success col-md-8">
            ...
            <div class="form-group has-success col-md-8">
               ...
               <input type="text" class="form-control" id="inputSuccess1" name="subcat_name" required>
             </div> 
             <div class="form-group has-success col-md-8">
                 <label class="control-label" for="inputSuccess1">Image Web<span style="color:red;">*</span></label>
                 <input type="file" class="form-control" id="" name="userfile" required>
               </div>  
               <div class="form-group has-success col-md-8">
                 <label class="control-label" for="inputSuccess1">Image Application<span style="color:red;">*</span></label>
                 <input type="file" class="form-control" id="" name="userfile1" required>
               </div>         
