  ...
  <div class="container">
      ...
      <div class="page-header">
        <div class="page-title">
          <h3 style="color: #850035;">Edit User</h3>
        </div>
      </div>
      <div class="row">
          <div class="col-md-12">
      ...
      <div class="form-group has-success col-md-8">
        ...
        <input type="hidden" class="form-control" id="" name="id" value="<?php echo $x['id'];?>"readonly>
      ...
      <div class="form-group has-success col-md-8">
        ...
        <input type="text" class="form-control" id="tbNumbers" onkeypress="javascript:return isNumber(event)" name="mobile" value="<?php echo $x['mobile'];?>">
      </div>
      <div class="form-group has-success col-md-8">
       ...
       <div class="form-group has-success col-md-8">
        <label class="control-label" for="inputSuccess1">Zip Code<span style="color:red;">*</span></label>
        <input type="text" class="form-control" id="inputSuccess1" name="zip_code" value="<?php echo $x['zip_code'];?>">
      </div>
       <div class="form-group has-success col-md-8">
