...
td {
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i>Detail de la Sous-Cat&eacute;gorie </div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                ...
                                <table class="table table-bordered table-hover DynamicTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="numeric">Cat&eacute;gorie</th>
                              ...
                              foreach ($data as $row){ ?>
                               ...
                               <tr id='trrow".$row_con['id']."' >
                                 ...
                                 <td class="center" class="numeric"><?php echo $row_cat['name'];?></td>
                                  ...
                                  <td class="numeric">
                                   <a class='btn btn-info'  title='Edit' href='edit_sub_category.php?id=<?php echo $row_con['id'];?>'><i class='mdi-content-create'  >Modifier</i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel">MISE A JOUR</h4>
            </div>
             <div class="modal-body">
