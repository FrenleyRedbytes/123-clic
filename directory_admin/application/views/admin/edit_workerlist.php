    ...
    <body>
        ...
        <div class="container">
          ...
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              <li class="current">
                <i class="fa fa-home"></i>Modifier un Professionnel
              </li>
            </ul>
          </div>
          <div class="page-header">
            <div class="page-title">
              <h3>Modifier un Professionnel</h3>
            </div>
          </div>
          <div class="row">
      ...
      <td><input type="text" class="form-control" id="inputSuccess1" name="mobile" value="<?php echo $x['mobile'];?>" required></td>
			<td><input type="text" class="form-control" id="inputSuccess1" name="email" value="<?php echo $x['email'];?>"></td>
						 ...
						 <td><button class="btn btn-danger" name="add_category" type="submit">METTRE A JOUR</button></td>
