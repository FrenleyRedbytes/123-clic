...
td {
    word-wrap:break-word!important;
            ...
            <div class="container"> <!-- Start : Inner Page container -->
                <div class="crumbs">    <!-- Start : Breadcrumbs -->
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">Employ&eacute</li>
                    </ul>
                </div>  <!-- End : Breadcrumbs -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-table"></i> D&eacutetail de l'employ&eacute</div>                               
                                <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn mini green" href="<?php echo base_url() ; ?>index.php/specialist/add_worker">
                   ...
                   <tr><th>Id Employ&eacute</th><th>Pr&eacutenom</th><th>Nom</th><th>Adresse</th><th>Ville</th><th>T&eacutel&eacutephone</th><th>Email</th><th>Image</th><th>Modifier</th></tr>
                <?php
              echo "<br>";
              echo "<br>";
              echo "<br>";
      ...
      <td><img src="/directory/uploads/<?php echo $row['image']; ?>" alt="image"  height="50" width="50"/>
		    ...
		    <td><a href="<?php echo base_url(); ?>index.php/specialist/work_Data/<?php echo $row['work_id']; ?>">Modifier</a> - <a href=""><a href="<?php echo base_url(); ?>index.php/specialist/delete_workerdata/<?php echo $row['work_id']; ?>">Supprimer</a></td>
			</tr>
                  <?php }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel">Professionnel</h4>
            </div>
