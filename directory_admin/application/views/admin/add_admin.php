  ...
  <div class="container">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3 style="color: #850035;"> Ajouter un Administrateur</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        ?>
          ...
          <div class="form-group has-success col-md-8">
              <label class="control-label" for="inputSuccess1"> Email de l'administrateur<span style="color:red;">*</span></label>
              <input type="text" class="form-control" id="inputSuccess1" name="email" required>
          </div>
          <div class="form-group has-success col-md-8">
              <label class="control-label" for="inputSuccess1"> Mot de Passe de l'administrateur<span style="color:red;">*</span></label>
