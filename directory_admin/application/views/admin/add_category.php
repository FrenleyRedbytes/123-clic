  ...
  <div class="container">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3 style="color: #850035;">Ajouter une cat&eacute;gorie</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
         ...
         ?>
            <div class="form-group has-success col-md-8">
              ...
              <div class="form-group has-success col-md-8">
                 <label class="control-label" for="inputSuccess1">Image Web de la cat&eacute;gorie<span style="color:red;">*</span></label>
                 <input type="file" class="form-control"  name="userfile" required>
               </div>
               <div class="form-group has-success col-md-8">
                 <label class="control-label" for="inputSuccess1">Image APP de la cat&eacute;gorie<span style="color:red;">*</span></label>
