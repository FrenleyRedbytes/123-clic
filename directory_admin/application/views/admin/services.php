...
td {
       ...
       <!-- End : Side bar -->
        <div id="content">  <!-- Start : Inner Page Content -->
		  ...
		  <tr>
		    ...
		    <td><a href="<?php echo base_url(); ?>index.php/services/find_Data/<?php echo $row['serv_id']; ?>">Modifier</a>-||-<a href=""><a href="<?php echo base_url(); ?>index.php/services/delete_Data/<?php echo $row['serv_id']; ?>">Supprimer</a></td>
			</tr>
                  <?php }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel">Sp&eacute;cialiste</h4>
            </div>
