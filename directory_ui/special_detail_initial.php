...
<body>
	...
	<?php 
		...
		<?php 
				$specialist_id = 51;	
				$latitude = 43.6403047;
				$longitude = 5.086916500000029;	
				
				$DataQuery = @mysqli_query($con,"SELECT s.* FROM `specialist` s  where s.spr_id=$specialist_id");
			...
			<div class="col-md-12 col-md-offset-2" style="margin-top: 2em !important;margin-bottom:1em;">
				<div class="row">
						...
						<div class="col-md-5">
				 					...
				 					<span style="color:#c5074f;font-weight:bold;">L & C Coiffere</span>
				 					<br />
									<address>
										Cecilia Chapman
										711-2880 Nulla St.
				...
				<div class="row">
					<div class="col-md-8">
						<select id="location-search-list" name="cat" class="form-control" 
		                  style="border-radius:2px solid #fff;font-weight:bold;font-size: 13px;color:#fff;
		                 background:#009688 url(images/slt_btn_cat.png) top 50% right 15px no-repeat;">
				...
				<div class="row">
					<div class="col-md-8">
						<select id="location-search-list" name="cat" class="form-control" 
		                  style="border-radius:2px solid #fff;font-weight:bold;font-size: 13px;color:#fff;
		                 background:#009688 url(images/slt_btn_cat.png) top 50% right 15px no-repeat;">
		                    <option value="">Personelle Disponible</option>		                   
		                </select>
					</div>
				</div><br>
				<div class="row">
                  ...
                  <thead  style="font-family:Arial;background:#9a0440;color:#fff;font-weight:normal;">
                      <tr>
                        <th>
                        Dimanche<br>
                        <div id="daysStyleFinal">20 mai 2019</div>
                        </th>
                        <th>
                          Lundi<br>
                          <div id="daysStyleFinal">21 mai 2019</div>
                        </th>
                        <th>
                          Mardi
                          <div id="daysStyleFinal">22 mai 2019</div>
                        </th>
                        <th>
                          Mercredi
                          <div id="daysStyleFinal">23 mai 2019</div>
                        </th>
                        <th>
                          Jeudi
                          <div id="daysStyleFinal">24 mai 2019</div>
                        </th>
                        <th>
                          Vendredi
                          <div id="daysStyleFinal">25 mai 2019</div>
                        </th>
                        <th>
                          samedi
                          <div id="daysStyleFinal">9 mai 2019</div>
                        </th>
                    </tr>
                  </thead>
                  <tbody >
				...
				<div class="row">
					<div class="col-md-8">
					 <textarea  placeholder="Commentaire..." style="padding-left:14px;text-align: justify;
        white-space: normal;width:100%;" rows="4">
					 </textarea>
					</div>
				</div><br>
				<div class="row">
					<div class="col-md-8">
						<input class="btn" onclick="gotoPage('special_detail_new.php',<?php echo '1';?>)" style="float:right;background:#e6b53e;color:#fff;border-radius:10px;" value="Continue" type="button">
					</div>
				</div>
			</div>
		</div>
