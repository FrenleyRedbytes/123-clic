      ...
      <div class="col-sm-12 text-center">
        <div class="row">
          <div class="col-md-12 categories-heading bt_heading_3">
            <h1 style="color: #850035;">Sous-Cat&eacute;gorie</span></h1>
          ...
          <?php 
            $cat_id=$_GET['id'];            
            $data1=mysqli_query($con,"select * from subcategory where cat_id='$cat_id'");
            while($data_ar1=mysqli_fetch_array($data1)){
            ?>
            <div class="col-md-3">
              <div class="directory_one">
        <a href="detailzip.php?cat_id=<?php echo $cat_id;?>&subcat_id=<?php echo $data_ar1['subcat_id'];?>">
                   <div class="inside">
                 <img src="../directory_admin/uploads/<?php echo $data_ar1['logos']; ?>"></div>
                <h2><?php echo $data_ar1['subcat_name']; ?></h2></a>
