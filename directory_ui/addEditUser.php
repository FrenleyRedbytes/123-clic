...
#editStyle{
  margin-top: -1.8em;float: right;padding-right: 0.5em;color: #a79c9c;
} 
#liCss{
  color: #302c2c;
  font-weight: bold;
...
<div class="container">
  <div class="col-md-12 col-md-offset-2" style="margin-top: 2em !important;margin-bottom:1em;">
    <div class="row"> 
          <div class="col-md-3">
             <div class="row" style="border-bottom: 1px solid #b9b4b4;width: 8em;"> 
                <p>
                  <div class="inside" style="width:120px !important;height:120px !important;">
                    <img src="../directory_admin/uploads/manicure.jpg" />
                  </div>
                </p>
                <p>
                  <div class="col-md-2">
                    <a href="#" id="upload_link" class="anchor_class" style="margin-left:2em;color:#302c2c;">Edit</a>
                    <input id="upload" type="file"/>    
                        <!-- <a href="#" id="upload_link" style=""><img  aria-hidden="true" src="custom_img/plus.png" /></a><br>   -->         
                        <!-- <a href="#" id="upload_link" class="anchor_class" style="text-align:center;margin-left:-1em;opacity:0.6;">Upload your file</a>  -->
                  </div><br>
                </p>
              </div><br><br>
              <div class="row">
                  <ul style="list-style-type: none;" >
                    <li id="liCss">
                    <!-- <i class="fa fa-envelope-o fa-2x" style="color:#c5074f;" aria-hidden="true"></i> -->
                    <img src="images/mes_reservation.png" style="width:30px;height:30px;margin-bottom:0.3em;" />
                    <a href="appointment.php" style="color:#302c2c;">Mes Reservations</a>
                    </li>
                    <li id="liCss">
                    <!-- <i class="fa fa-cog fa-2x" style="color:#f26681;" aria-hidden="true"></i> -->
                    <img src="images/parametres_rappel.png" style="width:30px;height:30px;margin-bottom:0.3em;" />
                    <a href="parametersSettings.php" style="color:#302c2c;">Parametres Rappel</a>
                    </li>
                    <li id="liCss">
                    <!-- <i class="fa fa-heart fa-2x" style="color:#003564;" aria-hidden="true"></i> -->
                    <img src="images/mes_favoris.png" style="width:30px;height:30px;margin-bottom:0.3em;"/>
                    <a href="fav_list.php" style="color:#302c2c;">Mes Favoris</a>
                    </li>
                    <li id="liCss">
                    <!-- <i class="fa fa-user fa-2x" style="color:#a59702;" aria-hidden="true"></i> -->
                    <img src="images/mes_infos_personnelles.png" style="width:30px;height:30px;margin-bottom:0.3em;" />
                    <a href="" style="color:#302c2c;">Mes Infos Personnelles</a>
                    </li>
                    <li id="liCss">
                     <img src="images/mes_infos_personnelles1.png" alt="No image Found"style="width:30px;height:30px;margin-bottom:0.3em;" /> 
                    <a href="" style="color:#302c2c;">Mes Rendez Vous Perso</a>
                    </li>
                  </ul>
              </div>
          </div>
          <div class="col-md-5">
              ...
              <input type="text" style="z-index:1;box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <label id="formLabel">Last Name</label><br>
              <input type="text" style="box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <label id="formLabel">Contact No.</label><br>
              <input type="text" style="box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <label id="formLabel">Email ID</label><br>
              <input type="text" style="box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <label id="formLabel">Permanent Address</label><br>
              <input type="text" style="box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <label id="formLabel">Street No.</label><br>
              <input type="text" style="box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <label id="formLabel">City</label><br>
              <select  name="cat" class="form-control" style="background: #ffffff url(images/slt_btn_cat.png) top 50% right 15px no-repeat !important;">
                
              </select><br>
              <label id="formLabel">State</label><br>
              <select  name="cat" class="form-control" style="background: #ffffff url(images/slt_btn_cat.png) top 50% right 15px no-repeat !important;">
                
              </select><br>
              <label id="formLabel">Pin</label><br>
              <input type="text" style="box-shadow:none !important;height:37px;" placeholder="" class="form-control"/><i class="fa" id="editStyle" style=""   aria-hidden="true">Edit</i><br>
              <input class="btn" style="float:right;background:#f26681;color:#fff;border-radius:10px;" value="Soumettre" type="button">
          </div>
    </div>  
</div>
</div>
