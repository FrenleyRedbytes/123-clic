    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <div class="breadcrum-inner-header">
          <h1>Listing Grid</h1>
          <a href="index.php">Home</a> <i class="fa fa-circle"></i> <a href="about.php"><span>Listing Grid</span></a> </div>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="sorts-by-results">
          ...
          <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="disp-f-right">
              <div class="disp-style active"><a href="listing_grid.php"><i class="fa fa-th"></i></a></div>
              <div class="disp-style"><a href="listing_list.php"><i class="fa fa-th-list"></i></a></div>
            </div>
          </div>
        </div>
        <div class="row">
