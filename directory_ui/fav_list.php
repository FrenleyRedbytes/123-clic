...
<div class="container">
  <div class="col-md-12 col-md-offset-1" style="margin-top: 2em !important;margin-bottom:1em;">
    <div class="row"> 
          <div class="col-md-3">
                <h3 style="border-bottom: 1px solid #0e7a84;color:#0e7a84;float:left;
                 border-bottom:2px solid ##0e7a84;text-transform: none !important;width:80%;font-weight:bold;">
                Mes Favoris
                </h3>
          </div>
    </div><br>
    <div class="row">
          <div class="col-md-2">
                  <img style="text-align:center;width: 180px;height:120px;border: 2px solid #5c4949 !important; border-radius: 7px !important;" src="../directory_admin/uploads/manicure.jpg" />
          </div>
          <div class="col-md-2">        
                   <address>
                    <strong style="color:#9a0440;">L & C Coifferue</strong>
          ...
          <div class="col-md-1" style="margin-top:-1em;">
              <img src="images/cross_btn.png" style="width:30px;height:30px;"/>
          </div>
          <div class="col-md-2">
                  <img style="text-align:center;width: 180px;height:120px;border: 2px solid #5c4949 !important; border-radius: 7px !important;" src="../directory_admin/uploads/manicure.jpg" />
          </div>
