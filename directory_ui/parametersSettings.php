...
<div class="container">
    <div class="col-md-12 col-md-offset-2" style="margin-top: 2em !important;margin-bottom:1em;">
        <div class="row">
           <div class="col-md-11">
             <div class="col-md-5" style="margin-right:-0.2em;">
                <h3 style="border-bottom: 1px solid #003564;font-size: 20px;color:#003564;text-transform: none !important;width: 10em;font-weight:bold;">
                Parameters Rappels
                </h3>               
             </div> 
           </div>
         ...
         <div class="row">
            <div class="col-md-11">
              ...
              <div class="col-md-7">
                <h4 style="color: #a89e9e;font-size: 14px;">Recevoire Popup 24h avant</h4><br>
              </div>
              <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-11">
          <h4  style="color: #484343;font-weight: bold;font-size: 15px;margin-left: 1em;">Rappel 1 an  apres le dernier RDV:</h4><br>
          </div>
        </div>
        <div class="row">
            <div class="col-md-11">
            ...
            <div class="col-md-11">
              <hr style="width:74%;margin-left: 1em;border:1px solid #e0d1d161;" />
            </div>
          </div> 
          <div class="row">
            <div class="col-md-11">
