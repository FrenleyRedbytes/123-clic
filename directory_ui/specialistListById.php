  ...
  <div class="row" >
    <div class="col-md-12" style="margin-top: 2em !important;">
     ...
     // $specialist_id = $_GET['spe_id'];
      $latDefault = $_POST['latitude_zip'];
      $longDefault = $_POST['longitude_zip'];
      $cat_id = $_GET['cat_id'];
      ...
      ?>
          ...
          <div class="col-md-3">   
                ...
                <?php 
                    ...
                    <?php }else{?>
                        <p><input type="button" class="btn" class="btn" onclick1="gotoPage('special_detail_initial.php',<?php echo $specialist_id;?>)" style="background:#0e7a84;color:#fff;" value="VOIR LE SALON"/></p>
                 <?php
                    }
                 ?>
